...
def run_walkforward_validation(
    ...
    while start_idx + TEST_WINDOW <= n_dates:
        ...
        # ==================================================
        #
        # IC evaluates the canonical alpha signal.
        #
        # DO NOT multiply alpha by confidence here.
        #
        # ==================================================
        ...
        # ==================================================
        #
        # meta_test now contains the complete canonical
        # signal contract:
        #
        #     Prediction_Prob
        #     Probability
        ...
        # ==================================================
        # BACKTEST DATAFRAME SAFETY CHECK
        # ==================================================

        if (
            bt_df is None
            or not isinstance(bt_df, pd.DataFrame)
            or bt_df.empty
        ):
        ...
        if "Market_Regime" in test_data.columns:
            ...
            # ==================================================
            # BULL VOLATILE RETURN EFFICIENCY
            # ==================================================
        ...
        # ==================================================
        #
        # This remains a diagnostic/sizing metric.
        # It does NOT replace Prediction_Alpha.
        #
        # ==================================================
